            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Solid Packing</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="mx-3 my-3">
                            <div class='form-group row mb-3'>
                                <div class='col-md-3'>
                                    <a href='<?php echo site_url("packing/add_packing_solid"); ?>' id='btnAddNewPackingList' class='btn btn-primary'><i class='bx bx-plus-circle'></i> Add New</a>
                                </div>
