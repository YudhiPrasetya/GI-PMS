            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Daily In Finish Good Details</li>
                    </ol>
                </nav>
            </div>
        </div>
        <h6 class="mb-0 text-uppercase">Daily In Finish Good Details</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        <div class="mx-3 my-3">
                            ...
                            <table id="tableInFinishGood" class="table table-striped table-bordered table-sm nowrap" style="width:100%">
                                <thead>
                                    <th>No.</th>
                                    <th>Scan Date</th>
                                    <th>ORC</th>
...
<script>
    $(document).ready(function() {
        ...
        var tableInFinishGood = $('#tableInFinishGood').DataTable({
            ...
            ajax: {
                url: '<?= site_url('packing/fiter_by_line_view'); ?>',
                type: 'GET',
                dataType: 'JSON'
            },
            language: {
