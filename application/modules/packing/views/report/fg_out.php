...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Finish Good OUT Report</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        <div class="mx-3 my-3">
                            ...
                            <table id="fg_out" class="table table-bordered table-striped table-hover table-sm nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Tanggal</th>
    ...
    $(document).ready(function() {
        ...
        function datePacking() {
            ...
            table = $('#fg_out').DataTable({
                ...
                buttons: [{
                    extend: 'excel',
                    title: 'Finish Good OUT'
                }],
                ajax: {
                    url: '<?= site_url('packing/fg_out'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return '<button type="button" id="btn-detail" class="btn btn-primary btn-sm">Details</button>';
                        }
        ...
        $('#fg_out tbody').on('click', '#btn-detail', function() {
            ...
            let dt = $('#mydata').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('packing/detail_out'); ?>',
                    type: 'POST',
                    data: {
                        tgl: tgl,
                        orc: orc,
