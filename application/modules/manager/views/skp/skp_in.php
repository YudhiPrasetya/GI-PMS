...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Report SKP In</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        ...
                        <div class="mx-3 my-3">
                            ...
                            <table id="skp_in" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Tanggal</th>
                                        <th>ORC</th>
    ...
    $(document).ready(function() {
        ...
        function dateSkp() {
            ...
            table = $('#skp_in').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/filter_skp_in'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
        ...
        $('#skp_in tbody').on('click', '#btn-detail', function() {
            ...
            let dt = $('#mydata').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/detail_skp_in'); ?>',
                    type: 'POST',
                    data: {
                        tgl: tgl,
                        orc: orc,
