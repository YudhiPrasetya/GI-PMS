...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Report SKP OUT</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        ...
                        <div class="mx-3 my-3">
                            ...
                            <table id="skp_out" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Tanggal</th>
                                        <th>ORC</th>
    ...
    $(document).ready(function() {
        ...
        function datefg() {
            ...
            table = $('#skp_out').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/filter_skp_out'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
        ...
        $('#skp_out tbody').on('click', '#btn-detail', function() {
            ...
            let dt = $('#mydata').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/detail_skp_out'); ?>',
                    type: 'POST',
                    data: {
                        tgl: tgl,
                        orc: orc,
