    ...
    $(document).ready(function() {
        ...
        function showGrafikOutputSewing() {
            var grafikOutputSewingShift1 = $.ajax({
                type: 'GET',
                url: '<?= site_url("manager/ajax_get_grafik_sewing_today_shift"); ?>/' + 1,
                dataType: 'json'
            });
            var grafikOutputSewingShift2 = $.ajax({
                type: 'GET',
                url: '<?= site_url("manager/ajax_get_grafik_sewing_today_shift"); ?>/' + 2,
                dataType: 'json'
            });
            var countORCTodayShift1 = $.ajax({
                type: 'GET',
                url: '<?= site_url("manager/ajax_get_Count_ORC_Today_Shift"); ?>/' + 1,
                dataType: 'json'
            });
            var countORCTodayShift2 = $.ajax({
                type: 'GET',
                url: '<?= site_url("manager/ajax_get_Count_ORC_Today_Shift"); ?>/' + 2,
                dataType: 'json'
            });
            var totalDowTimeMachineShift1 = $.ajax({
                type: 'GET',
                url: '<?= site_url("manager/ajax_get_total_down_time_machine"); ?>/' + 1,
                dataType: 'json'
            });
            var totalDowTimeMachineShift2 = $.ajax({
                type: 'GET',
                url: '<?= site_url("manager/ajax_get_total_down_time_machine"); ?>/' + 2,
                dataType: 'json'
            });

            $.when(grafikOutputSewingShift1, grafikOutputSewingShift2, countORCTodayShift1, countORCTodayShift2, totalDowTimeMachineShift1, totalDowTimeMachineShift2).done(function(grafikOutputSewingShift1Rst, grafikOutputSewingShift2Rst, countORCTodayShift1Rst, countORCTodayShift2Rst, totalDownTimeMachineShift1Rst, totalDownTimeMachineShift2Rst) {
                ...
                //shift 2
                var totalOutputShift2 = grafikOutputSewingShift2Rst[0].reduce((n, {
                    output
                }) => n + (output == null ? 0 : parseInt(output)), 0);

                var totalLineShift2 = grafikOutputSewingShift2Rst[0].length;
                ...
                $('#outputSewingShift2').text(totalOutputShift2);
                $('#orcSewingShift2').text(countORCTodayShift2Rst[0].count_orc);
                $('#lineSewingShift2').text(totalLineShift2);
                $('#downtimeSewingShift2').text(totalDownTimeMachineShift2Rst[0].TotalDownTime);
