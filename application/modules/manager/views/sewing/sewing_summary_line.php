...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Sewing Summary Line</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        <div class="mx-3 my-3">
                            ...
                            <table id="SummaryLine" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <td>Tanggal</td>
                                        <td>Line</td>
    ...
    $(document).ready(function() {
        ...
        function datePacking() {
            ...
            table = $('#SummaryLine').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/get_data_summary_line'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
