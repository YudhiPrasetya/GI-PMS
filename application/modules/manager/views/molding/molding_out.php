...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Molding Out</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
    ...
    $(document).ready(function() {
        ...
        function datePacking() {
            ...
            table = $('#fg_in').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/daily_out_molding'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            return '<span class="badge text-bg-info text-white" style="cursor: pointer;" id="btn_outer">' + row['out_outermold'] + '</span> '
                        }
                    },
                    {
                        'className': 'text-center px-3',
                        render: function(data, type, row) {
                            return '<span class="badge text-bg-success text-white" style="cursor: pointer;" id="btn_mid">' + row['out_midmold'] + '</span> '
                        }
                    },
                    {
                        'className': 'text-center px-3',
                        render: function(data, type, row) {
                            return '<span class="badge text-bg-warning text-white" style="cursor: pointer;" id="btn_lin">' + row['out_linningmold'] + '</span> '
        ...
        $('#fg_in tbody').on('click', '#btn_outer', function() {
            ...
            let dt = $('#mydata').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/detail_molding_out'); ?>',
                    type: 'POST',
                    data: {
                        tgl: tgl,
                        orc: orc,
