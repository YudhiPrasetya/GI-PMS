...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Cutting IN By Date Range</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        ...
                        <div class="mx-3 my-3">
                            ...
                            <table id="tableInCutting" class="table table-bordered table-striped table-sm nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Tanggal</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function dateInCutting() {
            ...
            table = $('#tableInCutting').DataTable({
                autoWidth: false,
                processing: true,
                destroy: true,
                info: true,
                ...
                ajax: {
                    url: '<?= site_url('manager/daily_in_cutting'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
