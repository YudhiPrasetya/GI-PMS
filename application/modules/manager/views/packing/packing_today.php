            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title text-center"><b>Report Packing</b></h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="chart">
                                    <canvas id="barPackingToday" style="min-height: 500px; height: 500px; max-height: 500px; max-width: 100%;"></canvas>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="card  rounded-4 bg-gradient-rainbow bubble position-relative overflow-hidden">
                                    <div class="card-header text-center">
                                        <span><b>Packing Today</b></span>
                                        <h3 id="outputPacking" style="font-weight: bold;"></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="card col-md-12" style="padding: 10px;">
                <div class="card-warning">
                    <div class="card-header">
                        <h5 class="card-title text-center"><b>Output Packing Today</b></h5>
                    </div>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function showReportSewingLine() {
            ...
            $.ajax({
                url: '<?php echo site_url('manager/ajax_get_graph_packing'); ?>',
                type: 'GET',
                dataType: 'JSON',
                success: function(data) {
                    // console.log('cek:', data);
                    var chartReportCuttingCanvas = $('#barPackingToday').get(0).getContext('2d');
        ...
        function totalOutput() {
            ...
            $.ajax({
                url: '<?php echo site_url('manager/ajax_get_total_packing'); ?>',
                method: 'GET',
                dataType: 'json',
                ...
                success: function(rst) {
                    ...
                    document.getElementById('outputPacking').innerHTML = output;
        ...
        var table1 = $('#table1').DataTable({
            ...
            ajax: {
                url: '<?= site_url('manager/ajax_get_packing_today'); ?>',
                type: 'GET',
            },
            columns: [{
                    'data': 'orc'
        ...
        $('#table1').on('click', '.btnDetailToday', function() {
            ...
            $.ajax({
                url: "<?php echo site_url('manager/ajax_get_detail_orc_packing'); ?>/" + selectedRow,
                method: "GET",
                dataType: 'JSON',
                success: function(data) {
                    table3.clear();
