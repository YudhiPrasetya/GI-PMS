...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Report Juita In</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        ...
                        <div class="mx-3 my-3">
                            ...
                            <table id="juita_in" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Tanggal</th>
                                        <th>ORC</th>
    ...
    $(document).ready(function() {
        ...
        function dateSkp() {
            ...
            table = $('#juita_in').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/filter_juita_in'); ?>',
                    type: 'POST',
                    data: {
                        'datefrom': datefrom,
                        'dateto': dateto
        ...
        $('#juita_in tbody').on('click', '#btn-detail', function() {
            ...
            let dt = $('#mydata').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('manager/detail_juita_in'); ?>',
                    type: 'POST',
                    data: {
                        tgl: tgl,
                        orc: orc,
