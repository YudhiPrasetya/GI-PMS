<div class="wrapper">
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="<?php echo base_url('skp/dashboard'); ?>">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="<?= base_url('skp/output_skp'); ?>"><i class="lni lni-printer"></i>Output SKP</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li> <a href="<?= base_url('skp/report'); ?>"><i class='bx bx-plus-circle'></i></i>Date Range</a><span class=""></span>
                    </li>
                </ul>
            </li>
        </ul>
