...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Scan Output SKP</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const loadLine = () => {
            $('#line').empty();
            $.ajax({
                url: " <?= site_url('skp/ajax_get_all_line'); ?>",
                type: 'GET',
                dataType: 'JSON',
                beforeSend: function() {
        ...
        function check_barcode(barcode, id_line) {
            $.ajax({
                url: '<?php echo site_url("skp/ajax_check_by_barcode"); ?>/' + barcode + '/' + id_line,
                type: 'GET',
                dataType: 'json'
            }).done(function(dt) {
                if (!dt.success) {
