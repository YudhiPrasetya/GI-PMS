                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="my-1 text-white"><?= $inputToday[0]->total ?></h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="my-1 text-white"><?= $inputYesterday[0]->total ?></h4>
                            </div>
                            <div class="fs-1 text-white"><i class="bx bx-arrow-to-bottom"></i>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="my-1 text-white"><?= $outputToday[0]->total ?></h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="my-1 text-white"><?= $outputYesterday[0]->total ?></h4>
                            </div>
                            <div class="fs-1 text-white"><i class="bx bx-arrow-to-top"></i>
                            </div>
                        </div>
                ...
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div>
                                <h6 class="mb-0">Weekly Input Juita</h6>
                            </div>
            ...
            <div class="col-12 col-lg-6 d-flex">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div>
                                <h6 class="mb-0">Weekly Output Juita</h6>
                            </div>
                            <div class="dropdown ms-auto">
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        // chart 1
        $.ajax({
            url: "<?= site_url('juwita/getInputJuwitaChart'); ?>",
            type: 'GET',
            dataType: 'JSON'
        }).done(function(data) {
            let date = [];
        ...
        // chart 2
        $.ajax({
            url: "<?= site_url('juwita/getOutputJuwitaChart'); ?>",
            type: 'GET',
            dataType: 'JSON'
        }).done(function(data) {
            let date = [];
