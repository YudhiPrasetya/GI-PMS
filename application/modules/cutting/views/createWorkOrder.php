...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Work Order</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                        ...
                        <div class="p-4">
                            <form class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="qtyorder" required disabled>
                                </div>
                                <div class="col-md-4">
                            ...
                            <button type="button" class="btn btn-primary mt-3" id="AddBundle" disabled>Create Work Order</button>
    ...
    $(document).ready(function() {
        ...
        $('#orc').change(function() {
            ...
            $.ajax({
                ...
                $('#qtyorder').val(dt[0].quantity_ordered);
