     ...
     <div class="card-body">
      ...
      <div class="row mx-2 mt-3">
       <div class="col-lg-12">
        <div class="row">
         <div class="col-lg-6">
          <div class="row g-3 align-items-center mb-3">
           ...
           <!-- <div class="col-lg-4">
                                                <a href="<?php echo base_url('cutting/addBundleCutting'); ?>" type="button" class="btn btn-primary"><i class='bx bx-plus-circle'></i> Create Bundle</a>
                                            </div> -->
           <div class="col-lg-6">
        ...
        <table id="cuttingTable" class="table table-striped table-bordered table-sm" style="width:100%">
         <thead>
          <th>No.</th>
          <th>ORC</th>
          <th>Work Order</th>
 ...
 $(document).ready(function() {
  ...
  let cuttingTable = $('#cuttingTable').DataTable({
   ...
   columns: [{
    ...
    {
     'className': 'text-center align-middle p-0 text-nowrap',
     render: function(data, type, row) {
      return "<div class='btn-group py-1 px-1' role='group'><button class='btn btn-primary btn-sm mx-2' id='btn-modal'>Size Detail</button><button class='btn btn-danger btn-sm' id='btn-delete'>Delete</button></div>";
