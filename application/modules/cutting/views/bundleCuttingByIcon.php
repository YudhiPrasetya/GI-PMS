    ...
    $(document).ready(function() {
        ...
        $('#orc').change(function() {
            ...
            $.ajax({
                ...
                console.log('dt: ', dt);
                var stylec = dt[0].style_code;
                var stylen = dt[0].style_name;
                let result = stylec + " " + stylen;
                console.log(result);
                $('#style_code').val(result);
                ...
                $('#po_customer').val(dt[0].po_customer);

                $('#consignee_name').val(dt[0].consignee_name);
                ...
                $('#quantity_ordered').val(dt[0].quantity_ordered);
                quantity_ordered = dt[0].quantity_ordered;
