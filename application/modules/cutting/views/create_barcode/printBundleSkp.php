            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Print SKP Bundle</li>
                    </ol>
                </nav>
            </div>
        </div>
        <h6 class="mb-0 text-uppercase">Print SKP Bundle</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card rounded-4 w-100">
                    <div class="card-body">
                        ...
                        <table id="orcSkpTable" class="table table-striped table-bordered table-sm nowrap" style="width:100%">
                            <thead>
...
<script>
    $(document).ready(function() {
        ...
        $('#orcSkpTable tbody').on('click', 'tr', function() {
        ...
        $('#btnPrintSelected').click(function() {
            ...
            // localStorage.clear();
            localStorage.removeItem('selectedSkpRows');

            localStorage.setItem("selectedSkpRows", JSON.stringify(selRows));


            window.open("<?php echo site_url('cutting/show_print_bundle_skp'); ?>");
        });
