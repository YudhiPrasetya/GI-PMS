            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Report Machine Breakdown</li>
                    </ol>
                </nav>
            </div>
        </div>
        <h6 class="mb-0 text-uppercase">Summary Machine Breakdown</h6>
        <hr />
        <div class="row">
            <div class="col-12 ">
                <div class="card">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#breakdownTable').DataTable({
            "scrollX": true,
            dom: 'Blfrtip',
            "paging": true,
            lengthMenu: [
        ...
        $('#filter').click(function() {
            ...
            var head = '<?= $this->session->userdata('username'); ?>';
            ...
            if (from_date != '' && to_date != '') {
                if (tgl1 > tgl2) {
                    ...
                    $.ajax({
                        url: '<?php echo site_url("head/filter_daily_downtime"); ?>',
                        method: "POST",
                        data: {
                            'dataStr': dataStr
                        },
