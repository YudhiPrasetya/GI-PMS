...
<div class="page-wrapper">
  <div class="page-content">
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Machine Waiting Monitoring</li>
          </ol>
        </nav>
      </div>
      <!-- <div class="ms-auto">
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Machine Waiting Monitoring</h6>
    <hr />
  ...
  <script>
    $(document).ready(function() {
      ...
      function show1stFloorData() {
        $.ajax({
          type: 'GET',
          url: '<?php echo site_url("mechanic/ajax_get_1stfloor_waiting_data"); ?>',
          cache: false,
          dataType: 'json'
        }).done(function(data) {
          // console.log(data);
      ...
      function fetch1stFloorData() {
        $.ajax({
          type: 'GET',
          url: '<?= site_url("mechanic/ajax_get_1stfloor_waiting_data"); ?>',
          cache: false,
          dataType: 'json'
        }).done(function(data) {
          firstFloorColNew = [];
