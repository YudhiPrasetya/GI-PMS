...
<div class="page-wrapper">
  <div class="page-content">
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Production Report (New)</li>
          </ol>
        </nav>
      </div>
      <!-- <div class="ms-auto">
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Production Report (New)</h6>
    <hr />
    ...
    <div class="card">
      <div class="card-body">
        <div class="row my-3 mx-2">
          <table id="productionReportTable" class="table table-striped table-bordered table-sm nowrap display" style="width:100%">
            <thead>
              <tr>
                <th>No.</th>
                <th>Style</th>
...
<script>
  $(document).ready(function() {
    ...
    let productionReportTable = $('#productionReportTable').DataTable({
      ...
      scrollX: true,
      ajax: {
        url: '<?= site_url('ppic/getNewReportPlanningProduction'); ?>',
        type: 'GET'
      },
      columns: [{
          "data": null,
    ...
    $('#productionReportTable tbody').on('click', '#output_packing_size_details', function() {
      ...
      let outputPackingSizeDetailsTable = $('#outputPackingSizeDetailsTable').DataTable({
        ...
        destroy: true,
        ajax: {
          url: '<?= site_url('ppic/getNewOutputPackingSizeDetails'); ?>',
          type: 'GET',
          data: {
            'orc': orc
          }
    ...
    $('#productionReportTable tbody').on('click', '#btn_details_all_dept', function() {
      ...
      let outputAllDeptSizeDetailsTable = $('#outputAllDeptSizeDetailsTable').DataTable({
        ...
        destroy: true,
        ajax: {
          url: '<?= site_url('ppic/getNewOutputAllDeptSizeDetails'); ?>',
          type: 'GET',
          data: {
            'orc': orc
          }
