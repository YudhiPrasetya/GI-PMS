...
<script>
  $(document).ready(function() {
        ...
        $.ajax({
          ...
          $.each(data, function(i, item) {
            $('#part').append(`<div class="row">
                                ...
                                <div class="col-lg-3">
                                  <select id="defect_` + item.code + `" class="form-control select2_1 defect" style="width: 100%;" disabled></select>
                                </div>
                                <div class="col-lg-2">
                                  <input type="text" id="other_defect_` + item.code + `" class="form-control other_defect" placeholder="e.g Other Defect" disabled>
                                </div>
                                <div class="col-lg-4">
                                  <input type="text" id="remarks_` + item.code + `" class="form-control remarks" placeholder="e.g Your Remarks" disabled>
                                </div>
                              </div>`);

            // $('#other_defect_' + item.code).hide();
            ...
            $('#part_' + item.code).change(function() {
              if ($(this).not(":checked").length > 0) {
                ...
                if ($(this).val() == 30) {
                  $('#part').append(`<div class="row other_part">
                                <div class="col-lg-2">
                                  <div class="form-check">
                                    <input type="text" id="other_part_` + item.code + `" class="form-control mb-2" placeholder="e.g Sling">
                                  </div>
                              </div>`);
                }
          ...
          $.each(data, function(i, item) {
            ...
            $('#defect_' + item.code).change(function() {
              ...
              if (id_defect == 35) {
                // $('#other_defect_' + item.code).show();
                // $('#other_defect_' + item.code).prop("type", "text");
                $('#other_defect_' + item.code).prop('disabled', false);


              } else {
                $('#other_defect_' + item.code).val('');
                // $('#other_defect_' + item.code).hide();
                // $('#other_defect_' + item.code).prop("type", "hidden");
                $('#other_defect_' + item.code).prop('disabled', true);
    ...
    $('#btn_save').on('click', function() {
      ...
      let other_part_val = $("#other_part_30").val();
