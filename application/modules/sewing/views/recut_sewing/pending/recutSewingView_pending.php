                ...
                <div class="row mt-5">
                  <div class="col-lg-12">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-lg-1" id="other_part">
                      </div>
                    </div> -->
                    ...
                    <div class="row">
                      <div class="col-lg-1">
                        <label for="part_label" class="col-form-label">Part <sup style="color: red;">*</sup></label>
                      </div>
                      <div class="col-lg-11" id="part">
    ...
    $('#item').change(function() {
      ...
      if (id_item != '') {
        $.ajax({
          ...
          $("#part").html('');
          $.each(data, function(i, item) {
            $('#part').append(`<div class="row mb-3">
                          <div class="col-lg-1">
                            <div class="form-check mt-2 mb-4">
                              <input class="form-check-input" name="part" type="checkbox" id="part_` + item.code + `" value="` + item.id + `"><label class="form-check-label" for="part_` + item.code + `">` + item.part_desc + `</label>
                            </div>
                          </div>
                          <div class="col-lg-1">
                            <input type="text" id="qty_part_` + item.code + `" class="form-control text-center mb-2 qty_part" placeholder="0" min="0" disabled>
                          </div>
                          <div class="col-lg-10">
                            <div class="row mb-2">
                              <div class="col-lg-3">
                                <select class="form-control select2_1 defect defect_1_` + item.code + `" style="width: 100%;" disabled></select>
                              </div>
                              <div class="col-lg-2">
                                <input type="text" class="form-control other_defect" placeholder="e.g Lain-lain">
                              </div>
                              <div class="col-lg-2">
                                <div class="form-check mt-2">
                                  <input class="form-check-input" name="part" type="checkbox" id="center_panel_` + item.code + `" value="1"><label class="form-check-label" for="center_panel_` + item.code + `">Center Panel</label>
                                </div>
                              </div>
                              <div class="col-lg-1">
                                <input type="text" id="qty_center_panel_` + item.code + `" class="form-control text-center qty_sub_part" placeholder="0" min="0">
                              </div>
                              <div class="col-lg-3">
                                <input type="text" id="remarks_center_panel_` + item.code + `" class="form-control remarks" placeholder="Remarks">
                              </div>
                            </div>
                            <div class="row mb-2">
                              <div class="col-lg-3">
                                <select class="form-control select2_1 defect defect_2_` + item.code + `" style="width: 100%;" disabled></select>
                              </div>
                              <div class="col-lg-2">
                                <input type="text" class="form-control other_defect" placeholder="e.g Lain-lain">
                              </div>
                              <div class="col-lg-2">
                                <div class="form-check mt-2">
                                  <input class="form-check-input" name="part" type="checkbox" id="linning_` + item.code + `" value="1"><label class="form-check-label" for="linning_` + item.code + `">Linning</label>
                                </div>
                              </div>
                              <div class="col-lg-1">
                                <input type="text" id="qty_linning_` + item.code + `" class="form-control text-center qty_sub_part" placeholder="0" min="0">
                              </div>
                              <div class="col-lg-3">
                                <input type="text" id="remarks_linning_` + item.code + `" class="form-control remarks" placeholder="Remarks">
                              </div>
                            </div>
                            <div class="row mb-2">
                              <div class="col-lg-3">
                                <select class="form-control select2_1 defect defect_3_` + item.code + `" style="width: 100%;" disabled></select>
                              </div>
                              <div class="col-lg-2">
                                <input type="text" class="form-control other_defect" placeholder="e.g Lain-lain">
                              </div>
                              <div class="col-lg-2">
                                <div class="form-check mt-2">
                                  <input class="form-check-input" name="part" type="checkbox" id="outer_` + item.code + `" value="1"><label class="form-check-label" for="outer_` + item.code + `">Outer</label>
                                </div>
                              </div>
                              <div class="col-lg-1">
                                <input type="text" id="qty_outer_` + item.code + `" class="form-control text-center qty_sub_part" placeholder="0" min="0">
                              </div>
                              <div class="col-lg-3">
                                <input type="text" id="remarks_outer_` + item.code + `" class="form-control remarks" placeholder="Remarks">
                              </div>
                            </div>
                          </div>
                        </div>`);
            ...
            $('#part_' + item.code).change(function() {
              if ($(this).not(":checked").length > 0) {
                ...
                $('.defect_1_' + item.code).prop('disabled', true);
                $('.defect_2_' + item.code).prop('disabled', true);
                $('.defect_3_' + item.code).prop('disabled', true);
                l
                // $('.defect_' + item.code).val('');
              } else {
                $('#qty_part_' + item.code).prop('disabled', false);
              }
            });
          ...
          $('.qty_sub_part').keypress(function(e) {
            let charCode = (e.which) ? e.which : e.keyCode;
            if (charCode > 31 && (charCode < 48 || charCode > 57)) {
              return false;
            }
        ...
        success: function(result) {
          ...
          if (result == 404) {
            ...
            Swal.fire({
              icon: "warning",
              title: "Warning!",
              text: 'Barcode has not been scanned in "Output Recut Cutting".',
              showConfirmButton: false,
              timer: 1500
            });
            $('#barcode_receipt').val('');
